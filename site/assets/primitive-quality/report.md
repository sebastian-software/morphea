...
| `diagonal_stroke_width_3` | `true` | `stroke_polyline` | 0.025977 | 0.035099 | 0.944861 | n/a |
| `diagonal_stroke_width_4` | `true` | `stroke_polyline` | 0.015625 | 0.024527 | 0.946783 | n/a |
...
| `diagonal_stroke_width_7` | `true` | `stroke_polyline` | 0.017383 | 0.033408 | 0.966573 | n/a |
| `diagonal_stroke_width_8` | `true` | `stroke_polyline` | 0.007422 | 0.008669 | 0.966217 | n/a |
| `diagonal_stroke_shallow` | `true` | `stroke_polyline` | 0.019531 | 0.029813 | 0.940362 | n/a |
| `diagonal_stroke_steep` | `true` | `stroke_polyline` | 0.013477 | 0.01459 | 0.937168 | n/a |
...
| `rounded_rectangle` | `true` | `rounded_rect` | 0.00926 | 0.009346 | 0.931713 | n/a |
| `rounded_rectangle_small_radius` | `true` | `rounded_rect` | 0.005992 | 0.006592 | 0.922727 | n/a |
| `rounded_rectangle_medium_radius` | `true` | `rounded_rect` | 0.019439 | 0.014818 | 0.94237 | n/a |
| `rounded_rectangle_tall` | `true` | `rounded_rect` | 0.014808 | 0.013096 | 0.946528 | n/a |
| `rounded_rectangle_wide` | `true` | `rounded_rect` | 0.010141 | 0.010255 | 0.926282 | n/a |
| `rounded_rectangle_small` | `true` | `rounded_rect` | 0.00629 | 0.0067 | 0.905093 | n/a |
| `rounded_rectangle_bottom` | `true` | `rounded_rect` | 0.010972 | 0.010295 | 0.929426 | n/a |
| `rounded_rectangle_top` | `true` | `rounded_rect` | 0.010972 | 0.010295 | 0.929426 | n/a |
| `rounded_rectangle_right` | `true` | `rounded_rect` | 0.013575 | 0.011823 | 0.9375 | n/a |
| `rounded_rectangle_left` | `true` | `rounded_rect` | 0.013575 | 0.011823 | 0.9375 | n/a |
